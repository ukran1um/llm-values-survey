...
def run_axis_cmd(axis_id, battery, models, reruns, cap, probes_dir, data_dir):
    ...
    click.echo(f"running axis={axis_id} pairs={n_pairs} reruns={reruns}")
    run_axis(axis, models=model_list, n_reruns=reruns, data_dir=data_dir, budget=budget)
